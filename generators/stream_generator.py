...
class RecurrentDriftStream(ConceptDriftStream):
    ...
    def next_sample(self, batch_size=1):
        ...
        if self.has_noise:
            self.cur_stream.perturbation = self.noise_level
        ...
        if self.sample_idx >= self.stable_period + self.width:
            ...
            if self.stream_idx != self.drift_stream_idx \
                and self.stable_period_logger is not None:
            ...
            # if self.has_noise and self.generator == 'agrawal':
                ...
                # if (self.cur_stream.perturbation = self.noises[self.noise_idx]
